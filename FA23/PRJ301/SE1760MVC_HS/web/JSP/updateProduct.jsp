<%-- 
    ...
    Created on : Oct 12, 2023, 8:41:57 AM
    Author     : alexf
--%>
...
<html>
    ...
    <body>
       ...
       <form action="ProductURL" method="post">
            ...
            ProductID:<input readonly="" type="text" name="pid" value="<%=product.getProductID()%>"/></br>
            ...
            Enter UnitsInStock:<input type="number" name="UnitsInStock" value="<%=product.getUnitInStock()%>"/></br>
